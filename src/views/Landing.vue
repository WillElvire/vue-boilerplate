    ...
    <div class="bg-indigo-900 px-4 py-4">
      <div class="md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
        <div class="flex justify-between items-center">
          <a href="#" class="inline-block py-2 text-white text-xl font-bold">SUCH</a>
        ...
        <div>
          <div class="hidden md:block">
            <a href="#" class="inline-block py-1 md:py-4 text-gray-100 mr-6 font-bold">
              Fonctionnement
            </a>
            <a href="#" class="inline-block py-1 md:py-4 text-gray-100 hover:text-gray-100 mr-6"
              >Nos services</a
            >
            <a href="#" class="inline-block py-1 md:py-4 text-gray-100 hover:text-gray-100">Blog</a>
          </div>
        </div>
        <div class="hidden md:block">
          ...
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              <h1 class="font-bold text-white text-2xl md:text-5xl leading-tight mb-4">
                Votre plateforme de sondage
              </h1>

              <p class="text-indigo-200 md:text-xl md:pr-48">
                Decouvrez les derniers sondages taillés sur mesure pour vous
              </p>
            ...
            <div class="md:w-1/2 relative">
              <div class="hidden md:block">
                ...
                >
                  ...
                  <div class="text-gray-800 text-center">Responsive</div>
                </div>
                ...
                >
                  ...
                  <div class="text-gray-800 text-center">Paiement en ligne <br /></div>
                </div>
